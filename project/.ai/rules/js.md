...
- The brand is always written `キタハラルチリドッグス札幌`, in both languages, including the header wordmark in `PublicLayout.vue` (which is not locale-dependent).
Full plan: LOCALIZATION-PLAN.md
